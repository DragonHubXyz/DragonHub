if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
    ...
    function library:AddWindow(text,keybind)
        local bind = keybind or Enum.KeyCode.F
        local ff = false
        local currenttab = ""
    ...
    --------------------------------------------------------------------
    local RenUi = library:AddWindow("Xyz Ware | BloxFruit",Enum.KeyCode.F)
    --------------------------------------------------------------------
    ...
    --------------------------------------------------------------------
    Main:AddSeperator("Pengaturan")
    
    Time = Main:AddLabel("Waktu Server")
    ...
    Main:AddToggle("Otomatis Set Spawn Points",true,function(value)
    ...
    if World1 then
        Main:AddToggle("Otomatis Second Sea",_G.AutoSecondSea,function(value)
    ...
    if World2 then
        Main:AddToggle("OtomatisThird Sea",_G.AutoThirdSea,function(value)
    ...
    if World2 then
        Main:AddToggle("Otomatis Farm Factory",_G.AutoFactory,function(value)
...
elseif game.PlaceId == 4520749081 or game.PlaceId == 6381829480 or game.PlaceId == 5931540094 or game.PlaceId == 5931540094 then
    ...
    --
    local RenUi = library:AddWindow("Xyz Ware | KL",Enum.KeyCode.RightControl)
    --
    local Main = RenUi:AddTab("Auto Farm","6026568198")
    local Stats = RenUi:AddTab("Stats","7040410130")
    local Combat = RenUi:AddTab("Combat","7251993295")
...
elseif game.PlaceId == 6329844902 then
    ...
    --
    local RenUi = library:AddWindow("Xyz Ware | LP",Enum.KeyCode.RightControl)
    --
    local Main = RenUi:AddTab("Auto Farm","6026568198")
    local Stats = RenUi:AddTab("Stats","7040410130")
    local Combat = RenUi:AddTab("Combat","7251993295")
